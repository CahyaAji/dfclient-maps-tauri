<script>
  ...
  $effect(() => {
    lat = locationStore.data.lat;
    lng = locationStore.data.lon;
...
<div class="container">
  <div class="input-panel">
    <div class="latlng-content">
      <div>
        <div>Latitude</div>
        <input type="number" bind:value={lat} readonly />
      </div>
      <div>
        <div>Longitude</div>
        <input type="number" bind:value={lng} readonly />
      </div>
    </div>
    <div class="utm-content">
      <div class="utm-field">
        <div>Zone :</div>
        <input type="text" bind:value={utmZone} readonly />
      </div>
      <div class="utm-field">
        <div>Northing :</div>
        <input type="text" bind:value={utmNorthing} readonly/>
      </div>
      <div class="utm-field">
        <div>Easting :</div>
        <input type="text" bind:value={utmEasting} readonly />
      </div>
      <div class="utm-field">
        <div>CO :</div>
        <input type="text" bind:value={utmCO} readonly />
      </div>
    </div>
  </div>
